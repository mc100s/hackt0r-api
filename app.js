...
// const clientRoot = path.join(__dirname, '../client/dist'); // Former line
// app.use('/', express.static(clientRoot)) // Former line
// app.use(history('index.html', { root: clientRoot })) // Former line
...
app.use((err, req, res, next) => {
  ...
  res.json(req.app.get("env") === "development" ? { error: err.message } : {});
});
